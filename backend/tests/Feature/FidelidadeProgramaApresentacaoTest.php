...
class FidelidadeProgramaApresentacaoTest extends TestCase
{
    ...
    public function test_linhas_catalogo_consulta_listam_produtos_e_quantidade(): void
    {
        ...
        $this->assertStringContainsString('Entre estes produtos', $linhas[0]);
        $this->assertStringContainsString('2 deles', $linhas[0]);
    ...
    public function test_como_funciona_menciona_delivery_da_loja(): void
    {
        $programa = (object) [
            'tipo_recompensa_padrao' => 'catalogo_consulta',
            'pedidos_meta' => 10,
