...
/**
 * Garante a tabela usada pela auditoria de fechamento e pelo dashboard de fechamentos.
 * Rode no servidor: php artisan migrate
 *
 * Se outra migration (2026_04_13_000002) já tiver criado a tabela, esta não altera nada.
 */
...
return new class extends Migration
{
    ...
    {
        // Não remove a tabela: pode conter dados de produção criados após esta migration.
    }
};
