...
<style>
/* 8pt — margem página simétrica (topo ≈ rodapé) + respiro leve antes/depois do conteúdo */
@page { margin: 12mm 8mm 12mm 8mm; }
html, body { width: 100%; margin: 0; padding: 0; }
body { font-family: DejaVu Sans, sans-serif; font-size: 8pt; line-height: 1.3; color: #111; }
.rh-fp-top-spacer, .rh-fp-bottom-spacer { height: 8mm; min-height: 8mm; margin: 0; padding: 0; font-size: 0; line-height: 0; overflow: hidden; }
...
<div class="rh-fp-bottom-spacer" aria-hidden="true">&nbsp;</div>
</div>
</body></html>';
